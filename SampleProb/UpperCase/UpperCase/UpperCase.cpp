...
void CountEm::display() { //display the value cout << endl << endl;
...
int main() 
{
	...
	CountEm string1;
	//object of class CountEm 
	getInput(userInput); //get input from the user 
	string1.countUpper(userInput); //count the number of uppercasecharacters
...
void getInput(string& in)
{
	...
	getline(cin, in); //reads in everything until the enter key ispressed
}